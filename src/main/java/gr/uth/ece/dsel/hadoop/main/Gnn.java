package gr.uth.ece.dsel.hadoop.main;
...
public class Gnn
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		// Phase 1
		// execute (<input path> <output path> <N> <partitioning> <reducers>)
		...
		// Phase 3
		// execute (<input path 1> <input path 2> <output path> <namenode name> <treeDir> <treeFileName> <overlapsDir> <overlapsFileName> <queryDir> <queryFileName> <mbrCentroidDir> <mbrCentroidFileName> <gnn25Dir> <gnn25FileName> <heuristics> <fastSums> <N> <K> <partitioning> <mode> <reducers>)
